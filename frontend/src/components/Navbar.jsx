...
<div className='flex items-center gap-2 sm:gap-3'>
 <button className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
  ...
  <p  onClick={()=>navigate('/Buy')}  className='text-xs sm:text-sm font-medium text-gray-600'> Credit left :50</p>
 </button>
 <p className='text-gray-600 max-sm:hidden pl-4'> Hi, Chetan</p>
<div className='relative group'>
  <img src={assets.profile_icon} alt="" className='w-10 drop-shadow' />
  <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
    <ul className='list-nonw m-0 p-2 bg-white rounded-md border text-sm '>
...
<div className='flex items-center gap-2 sm:gap-5'>
  ...
  <p onClick={()=>navigate('/generate-text')} className='cursor-pointer'>Generate Text</p>
